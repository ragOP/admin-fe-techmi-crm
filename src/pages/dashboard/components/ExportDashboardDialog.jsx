...
import { exportDashboard } from "../helpers/exportDashboard";

const ExportDashboardDialog = ({ openDialog, onClose, params }) => {
  const { mutate: exportMutation, isPending } = useMutation({
    mutationFn: async (type) => {
      ...
      const apiResponse = await exportDashboard({ params: updatedParams });
