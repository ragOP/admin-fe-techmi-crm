...
import { exportOrders } from "../helpers/exportOrders";

const ExportOrderDialog = ({
  openDialog,
  onClose,
  params,
}) => {
  const { mutate: exportMutation, isPending } = useMutation({
    mutationFn: async (type) => {
      ...
      const apiResponse = await exportOrders({ params: updatedParams });
...
export default ExportOrderDialog;
